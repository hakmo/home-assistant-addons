...
2. Click on the **...** in the upper right, the select **Respositories**. 
3. Add `https://github.com/hakmo/home-assistant-addons/` to your repositories.
2. Find the "Lego AH" add-on and click it.
...
Supported values: `rsa2048`, `rsa3072`, `rsa4096`, `rsa8192`, `ec256`, `ec384`. 

The default is `ec384`
...
DNS provider that will be used.

Supported values: `duckdns`. In the future, `cloudflare`, `godaddy`, `digitalocean`.`
...
[issue]: https://github.com/hakmo/home-assistant-addons/issues
